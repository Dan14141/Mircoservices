    ...
    <section class="py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-4xl font-extrabold text-gray-900 mb-4">Why Choose ClickStore?</h2>
    ...
    <section class="py-16 bg-gray-50 text-gray-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
          Join thousands of satisfied customers who trust ClickStore for their online shopping needs.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <BaseButton
            variant="primary"
